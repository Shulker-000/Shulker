...
// --- Mock Data ---
const mockMeetings = [
  { id: '1', title: 'Weekly Sync', date: 'August 20, 2025', time: '10:00 AM', status: 'Upcoming' },
  { id: '2', title: 'Project Shulker Demo', date: 'August 18, 2025', time: '02:30 PM', status: 'Completed' },
  { id: '3', title: 'Q3 Planning', date: 'August 22, 2025', time: '09:00 AM', status: 'Upcoming' },
  { id: '4', title: 'Client Onboarding', date: 'August 19, 2025', time: '04:00 PM', status: 'Completed' },
];

// --- API Utility Functions (placeholders) ---
const startNewMeeting = () => {
  console.log('Action: Starting new instant meeting...');
};
            ...
            <ul className="space-y-4">
              {upcomingMeetings.length > 0 ? (
                upcomingMeetings.map(meeting => (
                  <li key={meeting.id} className="p-4 rounded-2xl bg-gray-50 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    ...
                    <div className="mt-2 sm:mt-0 flex space-x-2">
                      <button onClick={() => joinMeeting(meeting.id)} className="flex items-center px-4 py-2 text-sm bg-purple-600 text-white rounded-full hover:bg-purple-700 transition-colors">
