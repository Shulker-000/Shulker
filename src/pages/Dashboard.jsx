...
      // Step 1: Create call on Stream
      console.log("Attempting to create call on Stream server...");
...
        },
      });
      console.log("Call successfully created on Stream server.");

      // Step 2: Save in backend
      const token = localStorage.getItem("authToken");
      console.log("Attempting to save meeting to backend...");
...
          },
          body: JSON.stringify({ user, meetingId: id }),
        }
      );
...
      console.log("Meeting creation and saving complete. Navigating...");
