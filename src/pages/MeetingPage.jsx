...
const MeetingPage = () => {
  ...
  // Show loading while fetching call or user is not loaded
  ...
  // Show message if call is not found
  if (!call) {
    return (
      <div className="flex flex-col items-center justify-center h-screen bg-gray-50 text-gray-800">
  ...
  // Check if user is allowed to join the call (for invited calls)
  ...
  // Render the meeting setup or the meeting room inside StreamCall context
  return (
