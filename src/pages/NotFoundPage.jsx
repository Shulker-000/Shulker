      ...
      <div className="flex min-h-screen w-full flex-col items-center justify-center bg-white p-6 text-center lg:hidden">
        ...
        >
          ...
          <motion.h1
            ...
            className="mt-6 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-8xl font-black text-transparent"
          >
            404
          </motion.h1>
          ...
          <motion.h2
            variants={itemVariants}
            className="mt-4 text-3xl font-bold tracking-tight text-gray-800"
          >
            Connection Lost
          </motion.h2>
          ...
          >
            We can't seem to find the page you're looking for. The link may be
            broken.
          </motion.p>
          ...
          >
            <a
              href="/"
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-indigo-600 px-6 py-3.5 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:bg-indigo-700 hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-indigo-500/50"
            >
            ...
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-gray-200 px-6 py-3.5 text-base font-semibold text-gray-800 shadow-md transition-all duration-300 hover:bg-gray-300 hover:-translate-y-0.5 focus:outline-none focus:ring-4 focus:ring-gray-500/50"
            >
          ...
          >
            <div className="flex items-center justify-center">
              ...
              <motion.span
                custom={1}
                variants={numberVariant}
                className="text-[12rem] px-4 font-black tracking-tighter text-white/80 select-none"
              >
                0
              </motion.span>
              <motion.span
        ...
        <div className="flex w-1/2 items-center justify-center p-6 sm:p-12 bg-gray-50">
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => window.history.back()}
                className="flex w-full sm:w-auto justify-center items-center gap-2 bg-white border border-gray-300 hover:bg-gray-100 text-gray-700 px-6 py-3 rounded-lg text-base font-semibold shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                <ArrowLeft className="h-5 w-5" />
                Go Back
              </button>
