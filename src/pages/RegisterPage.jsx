        ...
        <div className="text-center">
          <div className="flex justify-center">
            <div className="relative p-0">
              <img src="/LogoIcon.svg" alt="Logo" className="h-40 w-40 pb-0 mb-0" />
          ...
          <h2 className="text-2xl mt-0 sm:text-3xl font-bold mb-2" style={{ color: '#03045e' }}>
            Join CogniMeet
          </h2>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 backdrop-blur-sm bg-opacity-95">
          <div className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="block w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200"
                    style={{ 
                      color: '#023e8a',
                      '--tw-ring-color': '#0077b6'
                    }}
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Building className="h-5 w-5" style={{ color: '#0096c7' }} />
                </div>
                <input
                  id="company"
                  name="company"
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                <input
                  ...
                  onChange={handleInputChange}
                  className="h-4 w-4 mt-0.5 rounded border-gray-300 focus:ring-2 transition-colors"
            ...
            <button
              ...
              className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-lg text-white font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-200 hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:hover:shadow-sm"
              style={{ 
                background: 'linear-gradient(135deg, #0077b6 0%, #0096c7 100%)',
                '--tw-ring-color': '#48cae4'
              }}
              onMouseEnter={(e) => !e.target.disabled && (e.target.style.background = 'linear-gradient(135deg, #023e8a 0%, #0077b6 100%)')}
              onMouseLeave={(e) => !e.target.disabled && (e.target.style.background = 'linear-gradient(135deg, #0077b6 0%, #0096c7 100%)')}
            >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <button
                ...
                style={{ color: '#023e8a' }}
                onMouseEnter={(e) => {
                  e.target.style.background = 'linear-gradient(135deg, #caf0f8 0%, #ade8f4 50%)';
