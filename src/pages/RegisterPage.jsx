    ...
    if (type === "terms") {
      setModalContent({
        ...
        content: (
          <>
            <p>
              Welcome to Shulker! These terms and conditions outline the rules
              and regulations for the use of Shulker's Website, located at
              shulker.com.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Shulker if you do not agree to
              take all of the terms and conditions stated on this page.
            </p>
            <h4 className="font-semibold text-gray-700 pt-2">License</h4>
            <p>
              Unless otherwise stated, Shulker and/or its licensors own the
              intellectual property rights for all material on Shulker. All
              intellectual property rights are reserved. You may access this
              from Shulker for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>
            <p>
              You must not: Republish material from Shulker, Sell, rent or
              sub-license material from Shulker, Reproduce, duplicate or copy
              material from Shulker, Redistribute content from Shulker.
            </p>
          </>
        ),
      });
      ...
      setModalContent({
        ...
        content: (
          <>
            <p>
              Your privacy is important to us. It is Shulker's policy to respect
            ...
            <h4 className="font-semibold text-gray-700 pt-2">
            ...
            <p>
              Personal Information: We may ask for personal information, such as
              your: Name, Email, Social media profiles, Date of birth,
              Phone/mobile number.
            </p>
          </>
        ),
            ...
            >
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src =
                    "https://placehold.co/600x400/7c3aed/ffffff?text=Shulker";
                }}
              />
              ...
              <p className="mt-4 text-lg text-indigo-100 max-w-sm mx-auto">
                Unlock powerful collaboration tools and streamline your
                workflow.
              </p>
            </motion.div>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <motion.div variants={itemVariants}>
                  ...
                  {errors.password ? (
                    ...
                    <div className="flex items-center mt-2 text-xs text-gray-500">
                      <Check className="w-4 h-4 mr-1.5 opacity-50" /> At least 8
                      characters
                    </div>
                  )}
                </motion.div>
                ...
                {errors.agreeToTerms && (
                  <p className="-mt-3 ml-8 text-xs text-red-600">
                    {errors.agreeToTerms}
                  </p>
                )}
