...
const NavItem = ({ item, currentPath, onLinkClick, isMobile = false }) => {
  ...
  const navLinkClasses = isMobile
    ? `flex items-center w-full px-4 py-3 text-lg font-medium rounded-xl transition-colors duration-200 ${
        isActive
          ? "bg-blue-50 text-blue-600"
          : "text-gray-700 hover:bg-gray-100 hover:text-blue-600"
      }`
    : `flex items-center px-4 py-2 text-sm font-medium transition-all duration-200 rounded-lg hover:bg-gray-50 hover:scale-105 active:scale-95 ${
        isActive
...
const AuthButtons = ({ isMobile = false }) => {
  if (isMobile) {
    return (
      <div className="border-t border-gray-200 pt-4 pb-3 space-y-3 px-4">
        <Link
          to={authRoutes.login}
          className="block w-full text-center px-4 py-3 font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-xl transition-colors"
        >
          Log In
        </Link>
        <Link
          to={authRoutes.signup}
          className="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-xl font-medium shadow-md transition-all"
        >
          Sign Up
        </Link>
      </div>
  ...
  return (
    <>
      <Link
        to={authRoutes.login}
        className="text-gray-700 hover:text-blue-600 px-4 py-2 text-sm font-medium transition-colors hover:bg-gray-50 rounded-lg"
      >
        Log In
      </Link>
      <Link
        to={authRoutes.signup}
        className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg text-sm font-medium shadow-sm transition-all hover:shadow-md hover:scale-105 active:scale-95"
      >
        Sign Up
      </Link>
    </>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              <img src="/logo.png" className="h-16 w-16" alt="Shulker Logo" />
              <span className="text-xl font-bold text-purple-700 hover:scale-110 transition-transform">
                <span className="text-2xl text-purple-800 transition-transform">
                  S
                </span>
                hulker
              </span>
